...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_PATH, "db/rostrum.sqlite3"),  # Or path to database file if using sqlite3.
...
SECRET_KEY = 'qy)-&amp;1y))z$n^=2ypqbc^&amp;_g3-a910wf6#e_ow_zitt8%xd-lc'
...
ROOT_URLCONF = 'rostrum.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'rostrum.wsgi.application'
